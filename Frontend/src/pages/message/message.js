...
function Message() {
  ...
  useEffect(() => {
    if (chatId !== null) {
      ...
      wss.addEventListener("message", (event) => {
        console.log("event fata pe ",event.data);
        ...
        if (data?.type === "server:chathist") {
          ...
          if (!histdata || histdata.length === 0) {
            ...
            setChatInit(true); // Update state to indicate chat initialization
            return;
          }
  ...
  const handleClick = () => {
    console.log("chat karma started")
    ...
    <div className={styles.messageContainer}>
      <header>
        ...
        >
          ...
          <h4 className={`${styles.text} text-4xl`}>HarmonyAI</h4>
            <h6 className={`${styles.text} text-md`}>
